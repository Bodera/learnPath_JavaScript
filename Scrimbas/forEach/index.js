...
// Sort the expenses and refunds by year so we can use break and continue without worrying about order 
expensesAndRefunds.sort((a, b) => a.year - b.year)

let totalSpent = 0
const cutoffDate = 2024

for (let currentExpenseOrRefund of expensesAndRefunds) {
